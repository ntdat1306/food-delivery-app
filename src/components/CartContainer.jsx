...
const CartContainer = () => {
    ...
    return (
        <motion.div
            ...
            className="fixed bottom-0 right-0 w-full md:w-375 h-screen md:h-[calc(100vh-86px)] bg-white drop-shadow-md flex flex-col z-[50]"
        >
            ...
            {/* Bottom section */}
            {cartItems && cartItems.length > 0 ? ( // If cart have data
